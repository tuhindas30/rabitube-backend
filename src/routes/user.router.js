...
router.delete("/:userId/watchlater/:vId", WatchlaterController.removeFromWatchlater);
...
router.route("/:userId/playlists/:pId")
  .get(PlaylistController.getPlaylistVideos)
  .post(PlaylistController.saveToPlaylist)
  .delete(PlaylistController.deletePlaylist);

router.delete("/:userId/playlists/:pId/:vId", PlaylistController.deletePlaylistVideo);
